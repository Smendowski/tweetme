...
# BASE_DIR -> manage.py location, on same level as manage.py
...
SECRET_KEY = '2s)pr)a^wv9p#b(5xr-fsol!^2$7+n*a$urluhl8acq-#prr(3'
...
# We have a 'templates' directory. We should add it to out
# TEMPLATES
TEMPLATES = [
    {
